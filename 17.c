...
int main ()
{
	...
	printf("Curso de C \n");
	printf("Clase 17 - operadores Relacionales \n\n");
	...
	printf("comprobando relaciones entre edades con operaciones Relacionales y lógicos\n" );
	...
	iResult = iEdadJesus > iEdadMaria && 0 +1;
	printf("iEdadJesus > iEdadMaria && 0 + 1                          : %d\n", iResult);
